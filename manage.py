...
from oftoledo.app import create_app
from oftoledo.database import db
from oftoledo.settings import DevConfig, ProdConfig
from oftoledo.user.models import User, Role
from oftoledo.art.models import Portfolio, Art

CONFIG = ProdConfig if os.environ.get('OFTOLEDO_ENV') == 'prod' else DevConfig
...
def _make_context():
    ...
    return {'app': app, 'db': db,'User': User, 'Role': Role, 'Portfolio': Portfolio, 'Art': Art}
